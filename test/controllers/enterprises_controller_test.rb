...
class EnterprisesControllerTest < ActionController::TestCase
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post :create, enterprise: { address: @enterprise.address, base_price: @enterprise.base_price, capacity: @enterprise.capacity, cellphone: @enterprise.cellphone, description: @enterprise.description, name: @enterprise.name, telephone: @enterprise.telephone }
    end
  ...
  test "should update enterprise" do
    patch :update, id: @enterprise, enterprise: { address: @enterprise.address, base_price: @enterprise.base_price, capacity: @enterprise.capacity, cellphone: @enterprise.cellphone, description: @enterprise.description, name: @enterprise.name, telephone: @enterprise.telephone }
    assert_redirected_to enterprise_path(assigns(:enterprise))
  end
